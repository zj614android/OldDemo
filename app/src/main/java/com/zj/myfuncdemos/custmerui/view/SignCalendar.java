...
/**
 * 
 * ����ʱ�䣺2015��11��23�� ����11:19:16 ��Ŀ���ƣ�DataPlus
 * 
 * @author sxc ��˵����
 */
...
public class SignCalendar extends ViewFlipper implements
	...
	public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#29b6f6"); // ���ڱ��ⱳ����ɫ
	...
	public static final int COLOR_TX_THIS_DAY = Color.parseColor("#CD2836"); // ��������������ɫ
